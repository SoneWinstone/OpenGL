...
public:
    ...
    // uniform工具函数
    void setInt(const GLchar* name, GLint location);
...
void Shader::setInt(const GLchar *name, GLint location) {
    auto lc = glGetUniformLocation(this->program, name);
    glUniform1i(lc, location);
}

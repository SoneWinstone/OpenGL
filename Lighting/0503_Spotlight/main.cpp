...
int main() {
    ...
    // 彩色贴图效果
    // unsigned int specularMap = loadTexture((imgFolder + "container2_specular_rgb.png").c_str());
...
//    Shader lightShader("../vertex.shader", "../lightFragment.shader");
    ...
    shader.setFloat("light.outerCutOff", glm::cos(glm::radians(18.0f)));
    // 激活并绑定纹理
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader.use();
        // 设置聚光参数
        shader.setVec3("light.position", camera.Position); // 模拟手电筒
